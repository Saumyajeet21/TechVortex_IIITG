...
def train_and_save() -> None:
    """Train GradientBoosting on 14-feature synthetic dataset and save."""
    ...
    print("[PlasticModel] Training GradientBoosting (14 features, 300 estimators)...")
    model.fit(X_tr, y_tr)
    ...
    try:
        ...
        save_model_log(
            model_name="GradientBoosting PlasticRisk v2",
            n_features=len(FEATURE_COLS),
            n_samples=30000,
            mae=float(mae),
            r2_score=float(r2),
            hyperparams={"n_estimators": 300, "max_depth": 5, "learning_rate": 0.05, "noise_sigma": 0.005},
        )
